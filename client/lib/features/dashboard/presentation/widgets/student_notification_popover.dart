...
class StudentNotificationPopOver extends StatelessWidget {
  final Offset triggerOffset;
  final Size triggerSize;
  final VoidCallback onDismiss;

  const StudentNotificationPopOver({
    super.key,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            Provider.of<StudentNotificationProvider>(context, listen: false).markAllAsRead();
                          },
                          child: Text(
                            'Mark all as read',
                            style: GoogleFonts.inter(
                  ...
                  Container(
                    ...
                    child: Consumer<StudentNotificationProvider>(
  ...
  Widget _buildActivityItem(
    ...
    StudentNotificationProvider provider
  ) {
