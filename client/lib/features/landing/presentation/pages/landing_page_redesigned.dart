...
class LandingPage extends StatelessWidget {
  ...
  /// Builds the shield/verification icon for the landing page header
  ...
  /// Builds a numbered feature card with title and styling
  ///
  /// [number] - Card number (01, 02, 03, etc.)
  /// [title] - Feature title/description text
